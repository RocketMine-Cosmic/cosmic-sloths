...
• Sector victory bonus is now the dominant scoring path
...
## 📢 POST 4 — Balance Changes

```
🔧 **BALANCE CHANGES**

• Talent stack factor reduced (0.66×)
...
**Why:** Recurring sink that scales with squad size. Doesn't affect individual run scores.
```
