...
export default function UIOverlay({ hp, maxHp, time, duration, level, xp, xpRequired, gold, cosmicTokens, weapons = [], passives = [], onPause }) {
    ...
    return (
        <div className="absolute inset-0 pointer-events-none p-2 md:p-4 flex flex-col justify-between font-sans select-none" style={{ zIndex: 100 }}>
            <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-[#040108]/80 to-transparent pointer-events-none z-0"></div>
            <div className="flex justify-between items-start gap-1 md:gap-4 relative z-10">
