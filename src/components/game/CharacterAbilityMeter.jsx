...
export default function CharacterAbilityMeter({ engineRef }) {
    ...
    return (
        <div className={`fixed left-1/2 -translate-x-1/2 bottom-20 md:bottom-24 z-30 pointer-events-none w-44 md:w-56 bg-[#0b0416]/85 backdrop-blur-sm border ${theme.border} ${state.ready ? theme.ready : ''} rounded-lg px-2 py-1.5`}>
