                ...
                <div className="flex flex-col sm:flex-row gap-3 md:gap-6 mt-2 md:mt-4">
                    ...
                    {!hasRerolled && (
                        <div className="flex flex-col items-center gap-1">
                            ...
                            {(cosmicTokens || 0) < 2 && (
                                <a href="https://omen.foundation" target="_blank" rel="noopener noreferrer" className="text-[10px] text-purple-400 hover:text-purple-300 underline underline-offset-2">
                    ...
                    {revealedIndex !== null && (
                        <div className="flex flex-col items-center gap-1">
                            ...
                            {(cosmicTokens || 0) < 1 && (
                                <a href="https://omen.foundation" target="_blank" rel="noopener noreferrer" className="text-[10px] text-red-400 hover:text-red-300 underline underline-offset-2">
                                    Need OMENX? Get it at omen.foundation →
                                </a>
                            )}
                        </div>
