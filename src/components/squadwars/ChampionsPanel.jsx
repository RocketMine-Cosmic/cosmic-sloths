            ...
            {standings.length === 0 ? (
                ...
                <div className="space-y-2">
                    ...
                    {standings.map(s => {
                        ...
                        return (
                            <div key={s.squad_id} className={`flex items-center gap-3 p-3 rounded-lg border ${rankColor} ${isMine ? 'ring-2 ring-cyan-400/50' : ''}`}>
                                <div className="text-lg font-black w-10 text-center shrink-0">{rankIcon}</div>
                                ...
                                <div className="flex-1 min-w-0">
                                    <div className="font-bold text-white text-sm flex items-center gap-2 flex-wrap">
                                        <span className="truncate">{s.squad_name || 'Unknown'}</span>
