                ...
                <div className="mt-3 pt-3 border-t border-slate-800">
                    ...
                    <div className="grid grid-cols-3 gap-2">
                        <div className="bg-amber-950/30 border border-amber-700/40 rounded p-2">
                            ...
                            <div className="flex items-center gap-1 text-xs font-bold text-amber-200"><Coins className="w-3 h-3 fill-amber-400 text-amber-400" /> 1,500</div>
                            <div className="flex items-center gap-1 text-xs font-bold text-fuchsia-300"><Puzzle className="w-3 h-3 fill-fuchsia-400 text-fuchsia-400" /> 2</div>
                        </div>
                        <div className="bg-slate-800/50 border border-slate-700 rounded p-2">
                            ...
                            <div className="flex items-center gap-1 text-xs font-bold text-slate-300"><Coins className="w-3 h-3 fill-amber-400 text-amber-400" /> 500</div>
                        </div>
                        <div className="bg-slate-900/60 border border-slate-700 rounded p-2">
                            ...
                            <div className="flex items-center gap-1 text-xs font-bold text-slate-400"><Coins className="w-3 h-3 fill-amber-400 text-amber-400" /> 250</div>
                        </div>
                    </div>
                </div>
            )}
