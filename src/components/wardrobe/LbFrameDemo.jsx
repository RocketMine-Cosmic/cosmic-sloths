...
export default function LbFrameDemo({ frameId, frameUrl, charIcon = '🦥', name = 'Cosmic Legend', score = 472000 }) {
    ...
    // Row content — same layout for both render paths.
    const rowContent = (
    ...
    return (
        <div className="w-full bg-slate-950 rounded-lg p-6 flex flex-col items-center gap-3">
            ...
            {isStandard ? (() => {
                ...
                if (f.kind === 'gradient') {
                    return (
                        <div className={`w-full max-w-[640px] rounded-lg ${f.anim}`} style={{ padding: '2px', backgroundImage: f.gradient, backgroundSize: '200% 100%' }}>
                ...
                return (
                    <div className={`relative w-full max-w-[640px] aspect-[8/1] ${anim}`}>
                        ...
                        />
                        {/* Chest frames have decorative end caps — inset content to avoid overlap. */}
