                                    ...
                                    return (
                                        <div className="flex flex-col gap-4 mt-2 md:mt-8 pt-2 md:pt-6 border-t border-slate-700/40">
                                            ...
                                            <div className="flex flex-col sm:flex-row gap-2 bg-slate-900/50 p-3 rounded-lg border border-slate-700/50">
                                                ...
                                                <button onClick={() => buyBuff('gold')} disabled={hasGoldBuff || (save.cosmicTokens || 0) < 5} className={`flex-1 flex justify-between items-center px-3 py-2 rounded text-xs font-bold border transition-all ${hasGoldBuff ? 'bg-yellow-900/40 border-yellow-500/50 text-yellow-400' : 'bg-slate-800 border-slate-600 text-slate-300 hover:border-yellow-500 hover:text-yellow-400 disabled:opacity-50 disabled:cursor-not-allowed'}`}>
                                                    <span className="flex items-center gap-2">💰 +50% Gold {hasGoldBuff && '(ACTIVE)'}</span>
