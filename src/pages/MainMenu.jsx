...
export default function MainMenu({ isCarousel, onNavigateToPlay }) {
    ...
    return (
        <div 
            className={`${isCarousel ? 'min-h-[calc(100vh-80px)]' : 'min-h-screen'} w-full flex flex-col items-center justify-end pb-20 md:pb-28 relative overflow-hidden font-mono bg-no-repeat bg-cover md:bg-contain`}
