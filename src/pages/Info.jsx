            ...
            <div className="space-y-3">
                <div className="bg-slate-900/60 rounded-xl p-4 border border-amber-800/40">
                    ...
                    <div className="grid grid-cols-2 gap-1.5 text-[11px] font-mono mt-2">
                        ...
                        {topN >= 11 && <div className="bg-slate-900/60 border border-slate-700 rounded px-2 py-1 flex justify-between"><span className="text-slate-300">#11–{Math.min(20, topN)}</span><span className="text-white">3% each</span></div>}
                    </div>
