...
export const PLAYER_TITLES = [
    ...
    { id: 'Cosmic Destroyer', label: 'Cosmic Destroyer', tier: 'rare', buff: { damageMult: 0.04, areaMult: 0.03 },
    ...
    { id: 'Filthy Rich', label: 'Filthy Rich', tier: 'rare', buff: { goldMult: 0.06 },
      describe: () => 'Earn 750,000 gold (lifetime).',
      isUnlocked: (s) => s.totalGoldEarned >= 750000 },
    { id: 'Beyond Limits', label: 'Beyond Limits', tier: 'rare', buff: { xpMult: 0.06 },
      describe: () => 'Reach level 35 in a single run.',
      isUnlocked: (s) => s.maxLevelReached >= 35 },
    { id: 'Raid Trooper', label: 'Raid Trooper', tier: 'rare', buff: { damageMult: 0.05 },
